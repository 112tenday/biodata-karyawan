...
class PendidikanSearch extends Pendidikan
{
    ...
    {
        return [
            [['id', 'biodata_id', 'tahun_lulus'], 'integer'],
            [['jenjang', 'institusi', 'jurusan'], 'safe'],
            [['ipk'], 'number'],
        ];
    }
    ...
    public function search($params, $formName = null)
    {
        ...
        $query->andFilterWhere(['ilike', 'jenjang', $this->jenjang])
            ->andFilterWhere(['ilike', 'institusi', $this->institusi])
